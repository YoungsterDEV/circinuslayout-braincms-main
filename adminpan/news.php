							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<?php
										...
										if ($handle = opendir(''.$_SERVER['DOCUMENT_ROOT'].'/swf/c_images/web_promo'))
										{	
											while (false !== ($file = readdir($handle)))
											{
												...
												echo '<option name="topstory" data-image="'.$config['hotelUrl'].'/swf/c_images/web_promo/' . $file . '" value="'.$config['hotelUrl'].'/swf/c_images/web_promo/' . $file . '"';
									...
									<div class="imagebox">
										<img style="border-radius: 6px;"src="<?= $config['hotelUrl'];?>/swf/c_images/web_promo/choose.gif" name="topstory" border=0>
									</div>
									<br><br>
								</div>
							</div>
